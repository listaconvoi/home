...
const CANDIDATI = [
  { n: 1,  cognome: "Ardito",     nome: "Cesare Giulio",      citta: "Manchester",                    foto: "assets/candidati/ardito.jpg", bio: "Matematico di professione, originario di Roma e residente a Manchester da dieci anni. Attuale Presidente del Comites di Manchester. Amministratore della comunità Italiani a Manchester e fondatore di I3Italy, progetto dedicato all’informazione e all’assistenza per gli italiani in Inghilterra. Nel 2021 è stato eletto nel Comites di Manchester con la lista Italia4Italy. La sua attività si è concentrata soprattutto sulla rappresentanza istituzionale della comunità italiana del Nord dell’Inghilterra, portandone le istanze fino alle sedi nazionali, tra cui un’audizione alla Camera dei deputati lo scorso febbraio." },
  { n: 2,  cognome: "Islam",      nome: "Safiqul",            citta: "Birmingham",                    foto: "assets/candidati/islam.jpg", bio: "Attuale Vice-Presidente del Comites di Manchester." },
  ...
  { n: 21, cognome: "Singh",      nome: "Kamal Deep",          citta: "Birmingham",                              foto: "assets/candidati/singh.jpg", bio: "Sono Kamal e vivo e lavoro nel Regno Unito. Ho scelto di candidarmi per contribuire concretamente alla nostra comunità italiana, promuovendo una rappresentanza attenta, trasparente e vicina alle esigenze degli italiani all'estero." },
